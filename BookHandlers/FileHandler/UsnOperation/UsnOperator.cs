...
using BookHandlers.FileHandler.Win32.Structures;
using BookHandlers.FileHandler.Win32;
using BookHandlers.FileHandler.Win32.Constants;

namespace BookHandlers.FileHandler.UsnOperation
{
